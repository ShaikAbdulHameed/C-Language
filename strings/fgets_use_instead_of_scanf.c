...
int main()
{
    ...
    fgets(str,sizeof(str),stdin);// also use "fgets(str,20,stdin" //her 'str' is string, sizeof(str) it takes size of string to print, stdin(standard input) is to take input.
    printf("%s",str);
